...
cactus_img = pygame.image.load('practice/week10/materials/cactus_bricks.png')
cactus_img_rect = cactus_img.get_rect()
cactus_img_rect.left = 0
fire_img = pygame.image.load('practice/week10/materials/fire_bricks.png')
...
class Dragon:
    ...
    def __init__(self):
        self.dragon_img = pygame.image.load('practice/week10/materials/dragon.png')
...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load('practice/week10/materials/fireball.png')
...
class Mario:
    ...
    def __init__(self):
        self.mario_img = pygame.image.load('practice/week10/materials/maryo.png')
...
def game_over():
    ...
    music = pygame.mixer.Sound('practice/week10/materials/mario_dies.wav')
    music.play()
    topscore.top_score(SCORE)
    game_over_img = pygame.image.load('practice/week10/materials/end.png')
...
def start_game():
    canvas.fill(BLACK)
    start_img = pygame.image.load('practice/week10/materials/start.png')
...
def game_loop():
    while True:
        ...
        global  HIGH_SCORE
        flames_list = []
        pygame.mixer.music.load('practice/week10/materials/mario_theme.wav')
