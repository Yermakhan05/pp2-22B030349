...
query_create_user = "INSERT INTO customers1 (first_name, last_name) VALUES (%s, %s) RETURNING id;"
query_add_transaction = "INSERT INTO transactions1 (type_op, customer_id, amount) VALUES (%s, %s, %s);"
